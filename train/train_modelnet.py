...
from model.pointnet2_ssg import PointNet2ClsSSG
from model.pointnet2_msg import PointNet2ClsMSG
...
def main(args):
    ...
    print('Device:', device)
    net = PointNet2ClsSSG(num_class).to(device) if not args.use_msg else PointNet2ClsMSG(num_class).to(device)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-w', '--weight_decay', action='store', type=float, default=2e-5)
    ...
    parser.add_argument('-msg', '--use_msg', action='store_true', default=False)
