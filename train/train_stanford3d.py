...
from model.pointnet2_ssg import PointNet2SceneSegSSG
...
def train_epoch(train_loader, net, criterion, optimizer, device):
    ...
    for x, labels in tqdm(train_loader):
        ...
        output = net(x[:, :3, :], x[:, 3:, :]).permute(0, 2, 1)
...
def main(args):
    ...
    print('Device:', device)
    net = PointNet2SceneSegSSG(13).to(device)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-e', '--epochs', action='store', type=int, default=150)
